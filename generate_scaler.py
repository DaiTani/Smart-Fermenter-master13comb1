...
all_columns = utils.get_data_style(work_dir)
feature_columns = [col for col in all_columns if col not in ["Timestamp", "od_600"]]
features = df[feature_columns + ['od_600']].values.astype(np.float32)
# 提取12个特征（包含od_600）
#features = df[[
